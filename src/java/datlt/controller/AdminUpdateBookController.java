...
public class AdminUpdateBookController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            BookDTO updatedBook = new BookDTO(id, name, description, author, image, quantity, price);
            BookDAO dao = new BookDAO();
            
            boolean checkUpdate = dao.updateBookByAdmin(updatedBook);

        } catch (Exception e) {
            log("ERROR at AdminUpdateBookController: " + e.getMessage());
        } finally {
